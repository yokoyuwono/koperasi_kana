...
<div class="mb-4">
    <h2 class="text-xl font-semibold">Edit Data Nasabah</h2>
    <p class="text-xs text-slate-500 mt-1">
        Perbarui data nasabah jika ada perubahan informasi.
    </p>
</div>
        ...
        <div>
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input name="nama" value="{{ old('nama', $nasabah->nama) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <select name="id_agent"
                        ...
                        @foreach($agents as $agent)
                            <option value="{{ $agent->id }}"
                                {{ old('id_agent', $nasabah->id_agent) == $agent->id ? 'selected' : '' }}>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input name="telepon" value="{{ old('telepon', $nasabah->telepon) }}"
                               class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
        ...
        <div>
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input name="tempat_lahir" value="{{ old('tempat_lahir', $nasabah->tempat_lahir) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-xs font-medium text-slate-700 mb-1">Tanggal Lahir</label>
                    <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $nasabah->tanggal_lahir) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
            ...
            <div class="grid md:grid-cols-3 gap-4 mt-3">
                ...
                <div>
                    ...
                    <input name="agama" value="{{ old('agama', $nasabah->agama) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-4 mt-3">
                <div>
                    ...
                    <textarea name="alamat_KTP" rows="2"
                              class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">{{ old('alamat_KTP', $nasabah->alamat_KTP) }}</textarea>
                </div>
                <div>
                    <label class="block text-xs font-medium text-slate-700 mb-1">Alamat Sekarang</label>
                    <textarea name="alamat_sekarang" rows="2"
                              class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">{{ old('alamat_sekarang', $nasabah->alamat_sekarang) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input name="nama_ibu" value="{{ old('nama_ibu', $nasabah->nama_ibu) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-xs font-medium text-slate-700 mb-1">Nama Wali</label>
                    <input name="nama_wali" value="{{ old('nama_wali', $nasabah->nama_wali) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-xs font-medium text-slate-700 mb-1">NIK Wali</label>
                    <input name="NIK_wali" value="{{ old('NIK_wali', $nasabah->NIK_wali) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input name="jenis_pekerjaan" value="{{ old('jenis_pekerjaan', $nasabah->jenis_pekerjaan) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-xs font-medium text-slate-700 mb-1">Bidang Usaha</label>
                    <input name="bidang_usaha" value="{{ old('bidang_usaha', $nasabah->bidang_usaha) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-xs font-medium text-slate-700 mb-1">Penghasilan (per bulan)</label>
                    <input type="number" step="0.01" name="penghasilan" value="{{ old('penghasilan', $nasabah->penghasilan) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-4 mt-3">
                <div>
                    ...
                    <textarea name="alamat_perusahaan" rows="2"
                              class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">{{ old('alamat_perusahaan', $nasabah->alamat_perusahaan) }}</textarea>
                </div>
                <div>
                    ...
                    <textarea name="aktivitas_transaksi" rows="2"
                              class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">{{ old('aktivitas_transaksi', $nasabah->aktivitas_transaksi) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input name="rekening_bank" value="{{ old('rekening_bank', $nasabah->rekening_bank) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-xs font-medium text-slate-700 mb-1">Nomor Rekening</label>
                    <input name="nomor_rekening" value="{{ old('nomor_rekening', $nasabah->nomor_rekening) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-xs font-medium text-slate-700 mb-1">Nama di Rekening</label>
                    <input name="nama_rekening" value="{{ old('nama_rekening', $nasabah->nama_rekening) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-4 mt-3">
                <div>
                    ...
                    <input name="tujuan_rekening" value="{{ old('tujuan_rekening', $nasabah->tujuan_rekening) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-xs font-medium text-slate-700 mb-1">Sumber Dana</label>
                    <input name="sumber_dana" value="{{ old('sumber_dana', $nasabah->sumber_dana) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-xs font-medium text-slate-700 mb-1">Tanggal Daftar</label>
                    <input type="date" name="tanggal_daftar" value="{{ old('tanggal_daftar', $nasabah->tanggal_daftar) }}"
                           class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                    <p class="text-[11px] text-slate-400 mt-1">
                        Jika dikosongkan, akan menggunakan nilai sebelumnya atau tanggal hari ini.
                    </p>
                </div>
            </div>
        </div>
