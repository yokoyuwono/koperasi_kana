...
<div class="mb-4 flex flex-col gap-1">
    ...
    <p class="text-xs text-slate-500">
        Deposit yang sudah <strong>approved</strong> tidak bisa diubah.  
        Deposit dengan status <strong>rejected</strong> dapat diperbaiki dan dikirim ulang ke COA.
    </p>
                ...
                {{-- <div class="md:col-span-2 flex items-start gap-2">
                    ...
                    <label class="inline-flex items-start gap-2 cursor-pointer select-none mt-5 md:mt-6">
                        <input type="checkbox" name="BDP_ref" value="1"
                            {{ old('BDP_ref', $deposit->BDP_ref) ? 'checked' : '' }}
